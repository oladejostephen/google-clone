	...
	<div class="container" style="background-color:#f3f3f3;">
		...
		<nav>
		  <div class="nav nav-tabs" id="nav-tab" role="tablist">
		    <a class="nav-item nav-link active" id="nav-addedit-tab" data-toggle="tab" href="#nav-addedit" role="tab" aria-controls="nav-addedit" aria-selected="true">Trending/News</a>
		...
		<div class="tab-content" id="nav-tabContent">
		  <div class="tab-pane fade show active" id="nav-addedit" role="tabpanel" aria-labelledby="nav-addedit-tab">
					...
					<div class="row">
						...
						<div class="col-sm-3" style="background-color:#454645;">
					...
					<div class="row">
						<div class="col-sm-3">
							<div>
								<img src="https://storage.myseldon.com/news_pict_D9/D961E36E887A7725BFCB676A3D614F42" alt="..." class="img-thumbnail">
									<p>
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam ultrices auctor massa eget tincidunt. Nunc et condimentum sem.
									</p>

									<input class="btn btn-primary" id="value" type="button" value=" Show picture">
							</div>	
						</div>
						...
						<div class="col-sm-3">
							<div>
								<img src="https://www.thestate.com/opinion/letters-to-the-editor/kpljcz/picture115200033/alternates/LANDSCAPE_1140/TrumpSnarl5x3.1" alt="..." class="img-thumbnail">
