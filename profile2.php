...
<div class="header">
	...
	<div class="sidenav" style=" margin-top: 30px;">
				<header>
					<a href="#">Menu</a>
				</header>
			  <a href="#">User</a>
...
<div class="page_content">
		...
		<div class="container" style="background-color:#f3f3f3;">
		  ...
		  <div class="nav nav-tabs" id="nav-tab" role="tablist">
		    <a class="nav-item nav-link active" id="nav-addedit-tab" data-toggle="tab" href="#nav-addedit" role="tab" aria-controls="nav-addedit" aria-selected="true">Add edit</a>
		   ...
		   Bookmark
			...
			<a class="nav-item nav-link" id="nav-User-tab" data-toggle="tab" href="#nav-User" role="tab" aria-controls="nav-User" aria-selected="false">
		    Users
			</a>
		...
		<div class="tab-content" id="nav-tabContent">
		  <div class="tab-pane fade show active" id="nav-addedit" role="tabpanel" aria-labelledby="nav-addedit-tab">
		  	<div class="row">
			  	...
			  	<div class="col-sm-3" style="text-align: center;">
			  		<img src="https://im0-tub-com.yandex.net/i?id=dfa592540e193d2956aa05d05b42e290&n=13&exp=1" width="70%" class="rounded-circle" alt="Cinque Terre">
					<button type="button" class="btn btn-primary">Add to gallery</button>
			  	</div>

			  	<div class="col-sm-3">
			  		<h4 class="font-weight-bold" style="color: #363636;">Joseph Ann</h4>
			  		<p class="font-weight-bold" id="green">Developer</p>
			  	...
			  	<div class="col-sm-3">
			  		...
			  		<div class="detail-box" style="margin-top: 53px;">
							<ul class="ul-first">
								<li>Gender:</li>
								<li>height</li>
								<li>weight</li>
		 ...
		 <div class="tab-pane fade" id="nav-myfriends" role="tabpanel" aria-labelledby="nav-myfriends-tab">
		
		  	
		  	<div class="row">

			  	<div class="col-sm-3" style="text-align: center;">
			  		<img src="https://im0-tub-com.yandex.net/i?id=dfa592540e193d2956aa05d05b42e290&n=13&exp=1" width="60%" class="rounded-circle" alt="Cinque Terre">

			  		<p class="font-weight-normal" style="color:#1a598e;">Profile view:67</p>
			  		<p class="font-weight-normal" style="color:#1a598e;">Completed:78%</p>	
			  	</div>

			  	<div class="col-sm-5">
			  		<h4 class="font-weight-bold" style="color: #363636;">Joseph Ann</h4>
			  		<p class="font-weight-bold" id="green1">Developer</p>
		    ...
		    <div class="tab-pane fade" id="nav-User" role="tabpanel" aria-labelledby="nav-User-tab">
					...
					<div class="card" style="width: 23rem; float: right;">
					  <div class="card-header" >
					    <h6>Please click to apply</h6>
					  </div>
					  <div class="card-body">
