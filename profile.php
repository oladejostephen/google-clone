...
<div class="page_content">
		...
		<div class="container" style="background-color:#f3f3f3;">
		  ...
		  <div class="nav nav-tabs" id="nav-tab" role="tablist">
		    ...
		    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Work history</a>
		    <div class="right">
		    	<p id="red">Click here to edit</p>
		    </div>
		  ...
		  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
		  	<div class="row">
			  	...
			  	<div class="col-sm-3" style="text-align: center;">
			  		...
			  		<p class="font-weight-normal">Profile view:67</p>
			  		<p class="font-weight-normal">Completed:78%</p>	
			  	</div>
