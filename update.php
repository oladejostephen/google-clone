		...
		<div class="container" style="background-color:#f3f3f3;">
			...
			<nav>
			  <div class="nav nav-tabs" id="nav-tab" role="tablist">
				    <a class="nav-item nav-link active" id="nav-addedit-tab" data-toggle="modal" data-target="#exampleModal" href="#nav-addedit" role="tab" aria-controls="nav-addedit" aria-selected="true">Updater</a>
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h6 class="modal-title" id="exampleModalLabel">Currently updated file section<span id="right"><p>Edit</p></span></h6>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					        <p>Profile section not updated</p>
					      </div>
					    </div>
					  </div>
					</div>
