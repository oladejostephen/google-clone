...
<div class="page_content">
		...
		<div class="container" style="background-color:#f3f3f3;">
		  ...
		  <div class="nav nav-tabs" id="nav-tab" role="tablist">
		    <a class="nav-item nav-link active" id="nav-addedit-tab" data-toggle="tab" href="#nav-addedit" role="tab" aria-controls="nav-addedit" aria-selected="true">User profile</a>
		...
		<div class="tab-content" id="nav-tabContent">
		  <div class="tab-pane fade show active" id="nav-addedit" role="tabpanel" aria-labelledby="nav-addedit-tab">
		  	<div class="row">
			  	...
			  	<div class="col-sm-3" style="height: 20%;">
